...
if( answer == "A" || answer == "a"){
   ...
   a =  1;
    ...
    document.getElementById("result").innerHTML="Wrong Ans";
...
if( answer == "C" || answer == "c"){
   ...
   b = 1;
    ...
    document.getElementById("result2").innerHTML="Wrong Ans";
...
if( answer == "D" || answer == "d"){
   ...
   c = 1;
    ...
    document.getElementById("result3").innerHTML="Wrong Ans";
...
if( answer == "B" || answer == "b"){
   ...
   d = 1;
    ...
    document.getElementById("result4").innerHTML="Wrong Ans";
...
if( answer == "D" || answer =="d"){
   ...
   e = 1;
    ...
    document.getElementById("result5").innerHTML="Wrong Ans";
